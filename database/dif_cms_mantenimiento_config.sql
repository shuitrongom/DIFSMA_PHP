...
-- Tabla de páginas en mantenimiento (con grupo para organizar)
CREATE TABLE IF NOT EXISTS `mantenimiento_paginas` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `pagina_key` VARCHAR(100) NOT NULL,
  `pagina_nombre` VARCHAR(255) NOT NULL,
  `grupo` VARCHAR(100) NOT NULL DEFAULT 'Otros',
...
-- Páginas estáticas organizadas por grupo
INSERT INTO `mantenimiento_paginas` (`pagina_key`, `pagina_nombre`, `grupo`, `en_mantenimiento`) VALUES
('index',               'Página Principal',              'Inicio',              0),
('presidencia',         'Presidencia',                   'Acerca del DIF',      0),
('direcciones',         'Direcciones',                   'Acerca del DIF',      0),
('organigrama',         'Organigrama',                   'Acerca del DIF',      0),
('autismo',             'Unidad Municipal de Autismo',   'Servicios',           0),
('noticias',            'Noticias',                      'Comunicación Social', 0),
('galeria',             'Galería',                       'Comunicación Social', 0),
('voluntariado',        'Voluntariado',                  'Voluntariado',        0),
('seac',                'SEAC',                          'Transparencia',       0),
('cuenta_publica',      'Cuenta Pública',                'Transparencia',       0),
('presupuesto_anual',   'Presupuesto Anual',             'Transparencia',       0),
('pae',                 'PAE',                           'Transparencia',       0),
('matrices_indicadores','Matrices de Indicadores',       'Transparencia',       0),
('conac',               'CONAC',                         'Transparencia',       0),
('financiero',          'Financiero',                    'Transparencia',       0),
('avisos_privacidad',   'Avisos de Privacidad',          'Transparencia',       0)
ON DUPLICATE KEY UPDATE `pagina_nombre`=VALUES(`pagina_nombre`), `grupo`=VALUES(`grupo`);

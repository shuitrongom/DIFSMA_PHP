...
--
-- Table structure for table `fin_bloques`
--

DROP TABLE IF EXISTS `fin_bloques`;
...
--
-- Dumping data for table `fin_bloques`
--

LOCK TABLES `fin_bloques` WRITE;
/*!40000 ALTER TABLE `fin_bloques` DISABLE KEYS */;
INSERT INTO `fin_bloques` VALUES (1,2026,1);
/*!40000 ALTER TABLE `fin_bloques` ENABLE KEYS */;
UNLOCK TABLES;

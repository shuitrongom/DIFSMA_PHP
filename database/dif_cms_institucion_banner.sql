...
--
-- Table structure for table `institucion_banner`
--

DROP TABLE IF EXISTS `institucion_banner`;
...
--
-- Dumping data for table `institucion_banner`
--

LOCK TABLES `institucion_banner` WRITE;
/*!40000 ALTER TABLE `institucion_banner` DISABLE KEYS */;
INSERT INTO `institucion_banner` VALUES (1,'img/institucion.png','2026-03-19 18:15:34');
/*!40000 ALTER TABLE `institucion_banner` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Table structure for table `conac_bloques`
--

DROP TABLE IF EXISTS `conac_bloques`;
...
--
-- Dumping data for table `conac_bloques`
--

LOCK TABLES `conac_bloques` WRITE;
/*!40000 ALTER TABLE `conac_bloques` DISABLE KEYS */;
INSERT INTO `conac_bloques` VALUES (1,2026,1);
/*!40000 ALTER TABLE `conac_bloques` ENABLE KEYS */;
UNLOCK TABLES;

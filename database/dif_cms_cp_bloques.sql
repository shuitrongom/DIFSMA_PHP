...
--
-- Table structure for table `cp_bloques`
--

DROP TABLE IF EXISTS `cp_bloques`;
...
--
-- Dumping data for table `cp_bloques`
--

LOCK TABLES `cp_bloques` WRITE;
/*!40000 ALTER TABLE `cp_bloques` DISABLE KEYS */;
INSERT INTO `cp_bloques` VALUES (1,2025,1);
/*!40000 ALTER TABLE `cp_bloques` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Table structure for table `pa_bloques`
--

DROP TABLE IF EXISTS `pa_bloques`;
...
--
-- Dumping data for table `pa_bloques`
--

LOCK TABLES `pa_bloques` WRITE;
/*!40000 ALTER TABLE `pa_bloques` DISABLE KEYS */;
INSERT INTO `pa_bloques` VALUES (1,2026,1);
/*!40000 ALTER TABLE `pa_bloques` ENABLE KEYS */;
UNLOCK TABLES;

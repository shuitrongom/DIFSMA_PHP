...
--
-- Table structure for table `pae_titulos`
--

DROP TABLE IF EXISTS `pae_titulos`;
...
--
-- Dumping data for table `pae_titulos`
--

LOCK TABLES `pae_titulos` WRITE;
/*!40000 ALTER TABLE `pae_titulos` DISABLE KEYS */;
INSERT INTO `pae_titulos` VALUES (1,'1.- Programa Anual de Evaluaciones',1),(2,'2.- Términos de Referencia',2);
/*!40000 ALTER TABLE `pae_titulos` ENABLE KEYS */;
UNLOCK TABLES;

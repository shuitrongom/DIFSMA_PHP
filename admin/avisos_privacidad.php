...
<li class="nav-item"><a class="nav-link<?=$sc['file']==='avisos_privacidad.php'?' active':''?>" href="<?=htmlspecialchars($sc['file'])?>"><i class="bi <?=htmlspecialchars($sc['icon'])?>"></i> <?=htmlspecialchars($sc['title'])?></a></li>
<?php endforeach; ?>
</ul>

...
<thead class="table-light"><tr><th style="width:50px">#</th><th class="text-start">Concepto</th><th style="width:80px">PDF</th><th style="width:200px">Acciones</th></tr></thead><tbody>
<?php foreach($tC as $c):?>

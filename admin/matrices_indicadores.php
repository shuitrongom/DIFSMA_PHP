...
<div class="d-flex">
    <nav id="sidebar" class="sidebar d-flex flex-column">
        ...
        <ul class="nav flex-column mt-2">
            ...
            <li class="nav-item"><a class="nav-link<?= $sc['file']==='matrices_indicadores.php'?' active':'' ?>" href="<?= htmlspecialchars($sc['file']) ?>"><i class="bi <?= htmlspecialchars($sc['icon']) ?>"></i> <?= htmlspecialchars($sc['title']) ?></a></li>
            <?php endforeach; ?>
        </ul>

...
<div class="d-flex">
    <nav id="sidebar" class="sidebar d-flex flex-column">
        ...
        <ul class="nav flex-column mt-2">
            ...
            <li class="nav-item"><a class="nav-link<?= $sc['file']==='presupuesto_anual.php'?' active':'' ?>" href="<?= htmlspecialchars($sc['file']) ?>"><i class="bi <?= htmlspecialchars($sc['icon']) ?>"></i> <?= htmlspecialchars($sc['title']) ?></a></li>
            <?php endforeach; ?>
        </ul>
...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center" style="background-color:#333;color:#fff;">
        <span><i class="bi bi-bookmark-fill me-1"></i> <?= htmlspecialchars($concepto['nombre']) ?></span>
        <div>
